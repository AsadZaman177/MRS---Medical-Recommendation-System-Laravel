...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ url('medicines/body_part/store') }}" method="POST">
                        @csrf
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {{ $errors -> has('body_part') ? 'is-invalid' : '' }}" name="body_part" id="body_part" placeholder="E.g Head">
                                    @error('body_part')
